...
def p_instrucciones_lista(t):
    ...
    global gramatical
    gramatical += '<tr>'
    gramatical += '<td>INSTRUCCIONES -> INSTRUCCION INSTRUCCION_P</td>'
    gramatical += '<td>INSTRUCCIONES_P.add(INSTRUCCION); INSTRUCCIONES_P.reverse(); INSTRUCCIONES.val = INSTRUCCIONES_P</td>'
    gramatical += '</tr>'
...
def p_instrucciones_p(t):
    ...
    global gramatical
    gramatical += '<tr>'
    gramatical += '<td>INSTRUCCIONES_P -> INSTRUCCION INSTRUCCIONES_P</td>'
    gramatical += '<td>INSTRUCCIONES_P1.add(INSTRUCCION); INSTRUCCIONES_P.val = INSTRUCCIONES_P1</td>'
    gramatical += '</tr>'

def p_instrucciones_p_vacio(t):
    'instrucciones_p  :   '
    t[0] = []
    global gramatical
    gramatical += '<tr>'
    gramatical += '<td>INSTRUCCIONES_P -> None</td>'
    gramatical += '<td>INSTRUCCIONES_P.val = new list()</td>'
    gramatical += '</tr>'
...
def p_accesos_lista(t):
    ...
    global gramatical
    gramatical += '<tr>'
    gramatical += '<td>ACCESOS -> ACCESO INSTRUCCION_P</td>'
    gramatical += '<td>ACCESOS_P.add(ACCESO); ACCESOS_P.reverse(); ACCESOS.val = ACCESOS_P</td>'
    gramatical += '</tr>'
...
def p_accesos_p(t):
    ...
    global gramatical
    gramatical += '<tr>'
    gramatical += '<td>ACCESOS_P -> ACCESO ACCESOS_P</td>'
    gramatical += '<td>ACCESOS_P1.add(ACCESO); ACCESOS_P.val = ACCESOS_P1</td>'
    gramatical += '</tr>'

def p_accesos_p_vacio(t):
    'accesos_p  :   '
    t[0] = []
    global gramatical
    gramatical += '<tr>'
    gramatical += '<td>ACCESOS_P -> None</td>'
    gramatical += '<td>ACCESOS_P.val = new list()</td>'
    gramatical += '</tr>'
